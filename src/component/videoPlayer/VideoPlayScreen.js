...
export default class VideoPlayScreen extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      videoUrl: 'https://cdn.hopenglish.com/course_video/speakenglish.mp4',
              ...
              <View style={[styles.control, { width: this.state.videoWidth }]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress(); }}>
                  <Image
                    ...
                    source={this.state.isPlaying ? require('../../../assets/images/play-icon.png') : require('../../../assets/images/play-icon.png')}
                  />
                </TouchableOpacity>
                ...
                <Slider
                  ...
                  thumbImage={require('../../../assets/images/play-icon.png')}
                ...
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlShrinkPress(); }}>
                  <Image
                    ...
                    source={this.state.isFullScreen ? require('../../../assets/images/play-icon.png') : require('../../../assets/images/play-icon.png')}
                  />
                </TouchableOpacity>
              </View> : null
          }
